...
public class GameInstaller : MonoInstaller
{
    ...
    public override void InstallBindings()
    {
        ...
        var maxScore = new MaxScoreStorage(new BinaryStorage<int>(nameof(MaxScoreStorage)), score, _loseMaxScoreView);
        ...
        Container.BindInstance((ILevelCreator)new LevelCreator(_mazeFactory, score, _characterTeleport, gameTimer)).AsSingle();
