...
public class GameInstaller : MonoInstaller
{
    ...
    public override void InstallBindings()
    {
        ...
        var maxScore = new MaxScoreStorage(new BinaryStorage<IScore>(nameof(MaxScoreStorage)), score);
        ...
        Container.BindInstance((IMaxScore)new Wallet(new BinaryStorage<int>(nameof(Wallet)), _walletView));
    }
}